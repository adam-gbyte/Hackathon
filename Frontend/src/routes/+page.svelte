...
<section class="py-20 px-6">
    ...
    <div class="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        <div class="p-6 bg-blue-50 rounded-2xl shadow-sm">
            <h3 class="text-xl font-semibold mb-2 text-blue-700">Rekomendasi Cerdas</h3>
            <p class="text-gray-600">Sistem AI memberikan rekomendasi berdasarkan preferensi pengguna.</p>
        </div>

        <div class="p-6 bg-blue-50 rounded-2xl shadow-sm">
            <h3 class="text-xl font-semibold mb-2 text-blue-700">Data Produk UMKM</h3>
            <p class="text-gray-600">Katalog UMKM lengkap beserta kategori, lokasi, dan rating.</p>
        </div>

        <div class="p-6 bg-blue-50 rounded-2xl shadow-sm">
            <h3 class="text-xl font-semibold mb-2 text-blue-700">Antarmuka Modern</h3>
            <p class="text-gray-600">UI responsif & minimalis dengan Svelte + TailwindCSS.</p>
        </div>
    </div>
</section>
